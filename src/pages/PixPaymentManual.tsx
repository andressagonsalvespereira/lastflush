  ...
  useEffect(() => {
    ...
    const pollOrderStatus = async () => {
      ...
      if (isConfirmedStatus(normalizedStatus)) {
        ...
        setOrder(data); // mantém o pedido atualizado na tela
        setLoading(false);
      }
    };

    pollOrderStatus(); // executa imediatamente
    interval = setInterval(pollOrderStatus, 4000); // verifica a cada 4 segundos
